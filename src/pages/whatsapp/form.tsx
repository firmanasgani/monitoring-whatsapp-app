...
const WhatsappPhoneForm = () => {
  ...
  return (
    <LayoutPage>
        <div id="alert-box" className="hidden alert-box"></div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) => setWhatsappNumber({...whatsappNumber, phone_number: e.target.value})}
          ...
          {error && <p className="text-red-500">Nomor whatsapp harus sesuai dengan format 62xxxxxxxxxxxx atau 08xxxxxxxxxxxx</p>}
        </form>
      </div>
    </LayoutPage>
  );
